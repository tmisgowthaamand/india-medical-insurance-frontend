                ...
                {modelInfo.training_samples && (
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {modelInfo.test_samples ? modelInfo.test_samples.toLocaleString() : 'N/A'}
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="card">
            ...
            <div className="mt-4 p-3 bg-yellow-50 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Retraining will use the current dataset to rebuild the model. 
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>{uploading ? 'Uploading & Training...' : 'Upload & Retrain'}</span>
              </button>
            </div>
            
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Required columns:</strong> age, bmi, gender, smoker, region, 
                premium_annual_inr, claim_amount_inr
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <ul className="mt-1 space-y-1 text-gray-600">
                  <li>• <code className="bg-gray-100 px-1 rounded">age</code> - Customer age (18-100)</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">bmi</code> - Body Mass Index (10-50)</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">gender</code> - Male/Female</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">smoker</code> - Yes/No</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">region</code> - North/South/East/West</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">premium_annual_inr</code> - Annual premium in INR</li>
                  <li>• <code className="bg-gray-100 px-1 rounded">claim_amount_inr</code> - Claim amount in INR</li>
                </ul>
              </div>
            ...
            <div className="card">
              ...
              <div className="mt-4 p-3 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Insights:</strong> Higher values indicate more important features for prediction accuracy.
                </p>
              </div>
            </div>
          )}
                ...
                {modelInfo.test_rmse && (
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <p className="text-blue-600 font-medium">RMSE</p>
                      <p className="text-lg font-bold text-blue-800">
                        {formatCurrency(modelInfo.test_rmse)}
                      </p>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <p className="text-green-600 font-medium">Training Samples</p>
